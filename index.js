const NUM_TO_ALPHA_MAP = new Map([[15, 'f'], [14, 'e'], [13, 'd'], [12, 'c'], [11, 'b'], [10, 'a']]); // Adds prefix and replaces values greater than 9 with corresponding alphabet.

const hexProcessor = seq => [0, 'x', ...seq.map(item => item < 10 ? item : NUM_TO_ALPHA_MAP.get(item))].join(''); // Converts decimal values its target base equivalent.
